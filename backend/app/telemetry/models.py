...
class LiveTelemetrySnapshot:
    ...
    tyre_pressures_psi: list[float] = field(default_factory=lambda: [0.0, 0.0, 0.0, 0.0])
    tyre_wear_pct: list[float] = field(default_factory=lambda: [0.0, 0.0, 0.0, 0.0])
    tyre_damage_pct: list[int] = field(default_factory=lambda: [0, 0, 0, 0])
    wing_damage_pct: dict[str, int] = field(default_factory=lambda: {"fl": 0, "fr": 0, "rear": 0})

    world_position: list[float] = field(default_factory=lambda: [0.0, 0.0, 0.0])
    world_velocity: list[float] = field(default_factory=lambda: [0.0, 0.0, 0.0])
